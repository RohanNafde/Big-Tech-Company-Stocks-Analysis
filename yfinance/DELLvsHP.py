...
fname = r"C:\IIT\DS203\Project\yfinance\\DELL.csv"
df = pd.read_csv(fname)


fname1= r"C:\IIT\DS203\Project\yfinance\\HPQ.csv"
...
fig.add_trace(go.Candlestick(x=df['Date'],
                ...
                high=df['High'],
                low=df['Low'],
                close=df['Close'],name="DELL",increasing_line_color= 'purple', decreasing_line_color= 'gray'),
               row=1,col=1)
